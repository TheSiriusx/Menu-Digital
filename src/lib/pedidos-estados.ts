...
// aplica la base de datos (_cambiar_estado_pedido, migración 0009): aquí solo decide qué botones se ven.

export const ESTADOS = ["nuevo", "confirmado", "pagado", "entregado", "cancelado"] as const;
...
export const CUENTA_COMO_VENTA: readonly EstadoPedido[] = ["confirmado", "pagado", "entregado"];
